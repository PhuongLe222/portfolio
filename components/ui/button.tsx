...
const CTAButton = ({
  ...
  <a href={href}>
    <div className="group relative w-32 lg:w-40">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-primary to-primary-active rounded-xl opacity-50 blur-md group-hover:opacity-90 transition-all duration-700"></div>
      <div className="relative h-10 bg-surface backdrop-blur-xl rounded-lg border border-background/10 leading-none overflow-hidden">
        <div className="absolute inset-0 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500 bg-gradient-to-r from-primary/20 to-primary-active/20"></div>
        <span className="absolute inset-0 flex items-center justify-center gap-2 text-sm group-hover:gap-3 transition-all duration-300">
          <span className="bg-gradient-to-r from-sub-text to-foreground bg-clip-text text-transparent font-medium z-10">
            {text}
          </span>
          <Icon
